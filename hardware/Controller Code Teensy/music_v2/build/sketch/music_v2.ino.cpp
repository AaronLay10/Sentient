#include <Arduino.h>
#line 1 "/Users/aaron/Development/sentientengine.ai/hardware/Controller Code Teensy/music_v2/music_v2.ino"
// Music v2.3.0
...
SentientMQTT sentient(
    "mqtt.sentientengine.ai",
    1883,
    "paragon_devices",
    "wF9Wwejkjdml3EA599e1fTOb9xyAixaduEMID7UfDDs=",
    naming::CLIENT_ID,
    naming::ROOM_ID,
...
void setup()
{
  ...
  // Publish device registry and capabilities
  SentientDeviceRegistry::publishAll(sentient);
  SentientCapabilityManifest::publishManifest(sentient);
