...
namespace naming
{
    ...
    constexpr const char *HALL_A = "hall_sensor_a";
    constexpr const char *HALL_B = "hall_sensor_b";
    constexpr const char *HALL_C = "hall_sensor_c";
    constexpr const char *HALL_D = "hall_sensor_d";

    // Photocell sensor (input only)
    constexpr const char *PHOTOCELL = "photocell_lever";

    // Cube button (input only)
    constexpr const char *CUBE_BUTTON = "cube_button";

    // IR receiver (input only)
    constexpr const char *IR_RECEIVER = "ir_receiver";

    // Maglock (output device)
    constexpr const char *MAGLOCK = "maglock";

    // LED strips (output devices)
    constexpr const char *LED_STRIP = "led_strip_main";
    constexpr const char *LED_LEVER = "led_strip_lever";

    // COB light (output device)
    constexpr const char *COB_LIGHT = "cob_light";
