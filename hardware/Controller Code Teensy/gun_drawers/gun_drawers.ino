...
SentientDeviceDef dev_drawer_elegant(naming::DRAWER_ELEGANT, naming::FRIENDLY_DRAWER_ELEGANT, "electromagnet", naming::ACTION_TYPE_RELAY, drawer_commands, 2);
SentientDeviceDef dev_drawer_alchemist(naming::DRAWER_ALCHEMIST, naming::FRIENDLY_DRAWER_ALCHEMIST, "electromagnet", naming::ACTION_TYPE_RELAY, drawer_commands, 2);
SentientDeviceDef dev_drawer_bounty(naming::DRAWER_BOUNTY, naming::FRIENDLY_DRAWER_BOUNTY, "electromagnet", naming::ACTION_TYPE_RELAY, drawer_commands, 2);
SentientDeviceDef dev_drawer_mechanic(naming::DRAWER_MECHANIC, naming::FRIENDLY_DRAWER_MECHANIC, "electromagnet", naming::ACTION_TYPE_RELAY, drawer_commands, 2);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    if (strcmp(device_id, naming::DRAWER_ELEGANT) == 0)
    {
    ...
    else if (strcmp(device_id, naming::DRAWER_ALCHEMIST) == 0)
    {
        if (strcmp(command, naming::CMD_RELEASE_DRAWER) == 0)
        {
            digitalWrite(PIN_DRAWER_ALCHEMIST, LOW);
    ...
    else if (strcmp(device_id, naming::DRAWER_BOUNTY) == 0)
    {
        if (strcmp(command, naming::CMD_RELEASE_DRAWER) == 0)
        {
            digitalWrite(PIN_DRAWER_BOUNTY, LOW);
    ...
    else if (strcmp(device_id, naming::DRAWER_MECHANIC) == 0)
    {
        if (strcmp(command, naming::CMD_RELEASE_DRAWER) == 0)
        {
            digitalWrite(PIN_DRAWER_MECHANIC, LOW);
