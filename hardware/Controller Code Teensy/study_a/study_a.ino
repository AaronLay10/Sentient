...
SentientDeviceDef dev_tentacle_mover_a(naming::TENTACLE_MOVER_A, "Tentacle Mover A", "motor", naming::ACTION_TYPE_MOTOR, mover_commands, 3);
SentientDeviceDef dev_tentacle_mover_b(naming::TENTACLE_MOVER_B, "Tentacle Mover B", "motor", naming::ACTION_TYPE_MOTOR, mover_commands, 3);
SentientDeviceDef dev_riddle_motor(naming::RIDDLE_MOTOR, "Riddle Motor", "motor", naming::ACTION_TYPE_MOTOR, motor_commands, 2);
SentientDeviceDef dev_porthole_controller(naming::PORTHOLE_CONTROLLER, "Porthole Controller", "actuator", naming::ACTION_TYPE_SERVO, porthole_control_commands, 2, porthole_sensors, 6);
SentientDeviceDef dev_tentacle_sensors(naming::TENTACLE_SENSORS, "Tentacle Sensors", "sensor_array", naming::ACTION_TYPE_ANALOG_SENSOR, nullptr, 0, tentacle_sensors, 16);
...
void monitor_sensors()
{
    ...
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_A1, pa1);
        porthole_a1_last = pa1;
    }
    if (pa2 != porthole_a2_last)
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_A2, pa2);
        porthole_a2_last = pa2;
    }
    if (pb1 != porthole_b1_last)
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_B1, pb1);
        porthole_b1_last = pb1;
    }
    if (pb2 != porthole_b2_last)
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_B2, pb2);
        porthole_b2_last = pb2;
    }
    if (pc1 != porthole_c1_last)
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_C1, pc1);
        porthole_c1_last = pc1;
    }
    if (pc2 != porthole_c2_last)
    {
        publish_sensor(naming::PORTHOLE_CONTROLLER, naming::SENSOR_PORTHOLE_C2, pc2);
    ...
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_A1, ta1);
        tentacle_a1_last = ta1;
    }
    if (ta2 != tentacle_a2_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_A2, ta2);
        tentacle_a2_last = ta2;
    }
    if (ta3 != tentacle_a3_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_A3, ta3);
        tentacle_a3_last = ta3;
    }
    if (ta4 != tentacle_a4_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_A4, ta4);
        tentacle_a4_last = ta4;
    }
    if (tb1 != tentacle_b1_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_B1, tb1);
        tentacle_b1_last = tb1;
    }
    if (tb2 != tentacle_b2_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_B2, tb2);
        tentacle_b2_last = tb2;
    }
    if (tb3 != tentacle_b3_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_B3, tb3);
        tentacle_b3_last = tb3;
    }
    if (tb4 != tentacle_b4_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_B4, tb4);
        tentacle_b4_last = tb4;
    }
    if (tc1 != tentacle_c1_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_C1, tc1);
        tentacle_c1_last = tc1;
    }
    if (tc2 != tentacle_c2_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_C2, tc2);
        tentacle_c2_last = tc2;
    }
    if (tc3 != tentacle_c3_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_C3, tc3);
        tentacle_c3_last = tc3;
    }
    if (tc4 != tentacle_c4_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_C4, tc4);
        tentacle_c4_last = tc4;
    }
    if (td1 != tentacle_d1_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_D1, td1);
        tentacle_d1_last = td1;
    }
    if (td2 != tentacle_d2_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_D2, td2);
        tentacle_d2_last = td2;
    }
    if (td3 != tentacle_d3_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_D3, td3);
        tentacle_d3_last = td3;
    }
    if (td4 != tentacle_d4_last)
    {
        publish_sensor(naming::TENTACLE_SENSORS, naming::SENSOR_TENTACLE_D4, td4);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    // Tentacle Mover A
    if (strcmp(device_id, naming::TENTACLE_MOVER_A) == 0)
    {
    ...
    // Tentacle Mover B
    if (strcmp(device_id, naming::TENTACLE_MOVER_B) == 0)
    {
        if (strcmp(command, naming::CMD_UP) == 0)
        {
    ...
    // Riddle Motor
    if (strcmp(device_id, naming::RIDDLE_MOTOR) == 0)
    {
    ...
    // Porthole Controller
    if (strcmp(device_id, naming::PORTHOLE_CONTROLLER) == 0)
    {
