...
namespace naming
{
    ...
    constexpr const char *ENCODER_A = "encoder_a";
    constexpr const char *FRIENDLY_ENCODER_A = "Encoder A";

    constexpr const char *ENCODER_B = "encoder_b";
    constexpr const char *FRIENDLY_ENCODER_B = "Encoder B";

    // Controller device
    constexpr const char *CONTROLLER = "gear";
    ...
    // Rotary encoders (counter input)
    constexpr const char *ACTION_TYPE_COUNTER = "counter";
    // Controller device (relay output - used for virtual controller device)
