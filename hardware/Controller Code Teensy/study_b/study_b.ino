...
SentientDeviceDef dev_study_fan(naming::STUDY_FAN, "Study Fan", "stepper_motor", naming::ACTION_TYPE_MOTOR, motor_commands, 4);
SentientDeviceDef dev_wall_gear_1(naming::WALL_GEAR_1, "Wall Gear 1", "stepper_motor", naming::ACTION_TYPE_MOTOR, motor_commands, 4);
SentientDeviceDef dev_wall_gear_2(naming::WALL_GEAR_2, "Wall Gear 2", "stepper_motor", naming::ACTION_TYPE_MOTOR, motor_commands, 4);
SentientDeviceDef dev_wall_gear_3(naming::WALL_GEAR_3, "Wall Gear 3", "stepper_motor", naming::ACTION_TYPE_MOTOR, motor_commands, 4);
SentientDeviceDef dev_tv_1(naming::TV_1, "TV 1", "power_control", naming::ACTION_TYPE_RELAY, power_commands, 2);
SentientDeviceDef dev_tv_2(naming::TV_2, "TV 2", "power_control", naming::ACTION_TYPE_RELAY, power_commands, 2);
SentientDeviceDef dev_makservo(naming::MAKSERVO, "Makservo", "power_control", naming::ACTION_TYPE_RELAY, power_commands, 2);
SentientDeviceDef dev_fog_machine(naming::FOG_MACHINE, "Fog Machine", "fog_control", naming::ACTION_TYPE_TRIGGER, fog_commands, 3);
SentientDeviceDef dev_study_fan_light(naming::STUDY_FAN_LIGHT, "Study Fan Light", "light", naming::ACTION_TYPE_RELAY, power_commands, 2);
SentientDeviceDef dev_blacklights(naming::BLACKLIGHTS, "Blacklights", "light", naming::ACTION_TYPE_RELAY, power_commands, 2);
SentientDeviceDef dev_nixie_leds(naming::NIXIE_LEDS, "Nixie LEDs", "light", naming::ACTION_TYPE_RELAY, power_commands, 2);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    // Study Fan
    if (strcmp(device_id, naming::STUDY_FAN) == 0)
    {
    ...
    // Wall Gear 1
    if (strcmp(device_id, naming::WALL_GEAR_1) == 0)
    {
        if (strcmp(command, naming::CMD_START) == 0 || strcmp(command, naming::CMD_SLOW) == 0)
        {
            digitalWrite(PIN_MOTORS_POWER, HIGH);
    ...
    // Wall Gear 2
    if (strcmp(device_id, naming::WALL_GEAR_2) == 0)
    {
        if (strcmp(command, naming::CMD_START) == 0 || strcmp(command, naming::CMD_SLOW) == 0)
        {
            digitalWrite(PIN_MOTORS_POWER, HIGH);
    ...
    // Wall Gear 3
    if (strcmp(device_id, naming::WALL_GEAR_3) == 0)
    {
        if (strcmp(command, naming::CMD_START) == 0 || strcmp(command, naming::CMD_SLOW) == 0)
        {
            digitalWrite(PIN_MOTORS_POWER, HIGH);
    ...
    if (strcmp(device_id, naming::TV_1) == 0)
    {
    ...
    if (strcmp(device_id, naming::TV_2) == 0)
    {
    ...
    if (strcmp(device_id, naming::MAKSERVO) == 0)
    {
    ...
    if (strcmp(device_id, naming::STUDY_FAN_LIGHT) == 0)
    {
    ...
    if (strcmp(device_id, naming::BLACKLIGHTS) == 0)
    {
    ...
    if (strcmp(device_id, naming::NIXIE_LEDS) == 0)
    {
    ...
    // Fog machine
    if (strcmp(device_id, naming::FOG_MACHINE) == 0)
    {
