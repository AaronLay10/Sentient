...
namespace naming
{
    ...
    constexpr const char *FIRE_LEDS = "boiler_fire_leds";
    constexpr const char *MONITOR_POWER_RELAY = "boiler_monitor_power_relay";
    constexpr const char *NEWELL_POWER_RELAY = "newell_power_relay";
    constexpr const char *FLANGE_LEDS = "flange_leds";
    constexpr const char *PILOTLIGHT_COLOR_SENSOR = "pilotlight_color_sensor";
    ...
    // Color sensor (analog sensor input)
    ...
    // Power relays (digital relay output)
