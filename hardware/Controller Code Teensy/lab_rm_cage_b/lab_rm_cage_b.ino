...
SentientDeviceDef dev_door_three(naming::DOOR_THREE, "Door Three", "stepper_door", naming::ACTION_TYPE_MOTOR, door_commands, 3, door_sensors, 4);
SentientDeviceDef dev_door_four(naming::DOOR_FOUR, "Door Four", "stepper_door", naming::ACTION_TYPE_MOTOR, door_commands, 3, door_sensors, 4);
SentientDeviceDef dev_door_five(naming::DOOR_FIVE, "Door Five", "stepper_door", naming::ACTION_TYPE_MOTOR, door_commands, 3, door_sensors, 4);
...
void monitor_sensors()
{
    ...
    {
        publish_sensor(naming::DOOR_THREE, naming::SENSOR_OPEN_A, d3_open_a);
        d3_open_a_last = d3_open_a;
    }
    if (d3_open_b != d3_open_b_last)
    {
        publish_sensor(naming::DOOR_THREE, naming::SENSOR_OPEN_B, d3_open_b);
        d3_open_b_last = d3_open_b;
    }
    if (d3_closed_a != d3_closed_a_last)
    {
        publish_sensor(naming::DOOR_THREE, naming::SENSOR_CLOSED_A, d3_closed_a);
        d3_closed_a_last = d3_closed_a;
    }
    if (d3_closed_b != d3_closed_b_last)
    {
        publish_sensor(naming::DOOR_THREE, naming::SENSOR_CLOSED_B, d3_closed_b);
    ...
    {
        publish_sensor(naming::DOOR_FOUR, naming::SENSOR_OPEN_A, d4_open_a);
        d4_open_a_last = d4_open_a;
    }
    if (d4_open_b != d4_open_b_last)
    {
        publish_sensor(naming::DOOR_FOUR, naming::SENSOR_OPEN_B, d4_open_b);
        d4_open_b_last = d4_open_b;
    }
    if (d4_closed_a != d4_closed_a_last)
    {
        publish_sensor(naming::DOOR_FOUR, naming::SENSOR_CLOSED_A, d4_closed_a);
        d4_closed_a_last = d4_closed_a;
    }
    if (d4_closed_b != d4_closed_b_last)
    {
        publish_sensor(naming::DOOR_FOUR, naming::SENSOR_CLOSED_B, d4_closed_b);
    ...
    {
        publish_sensor(naming::DOOR_FIVE, naming::SENSOR_OPEN_A, d5_open_a);
        d5_open_a_last = d5_open_a;
    }
    if (d5_open_b != d5_open_b_last)
    {
        publish_sensor(naming::DOOR_FIVE, naming::SENSOR_OPEN_B, d5_open_b);
        d5_open_b_last = d5_open_b;
    }
    if (d5_closed_a != d5_closed_a_last)
    {
        publish_sensor(naming::DOOR_FIVE, naming::SENSOR_CLOSED_A, d5_closed_a);
        d5_closed_a_last = d5_closed_a;
    }
    if (d5_closed_b != d5_closed_b_last)
    {
        publish_sensor(naming::DOOR_FIVE, naming::SENSOR_CLOSED_B, d5_closed_b);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    // Door Three
    if (strcmp(device_id, naming::DOOR_THREE) == 0)
    {
    ...
    // Door Four
    if (strcmp(device_id, naming::DOOR_FOUR) == 0)
    {
        if (strcmp(command, naming::CMD_DOOR_OPEN) == 0)
        {
    ...
    // Door Five
    if (strcmp(device_id, naming::DOOR_FIVE) == 0)
    {
        if (strcmp(command, naming::CMD_DOOR_OPEN) == 0)
        {
