...
SentientDeviceDef dev_rfid_a(naming::READER_A, naming::FRIENDLY_RFID_A, "rfid_reader", naming::ACTION_TYPE_CODE_READER, rfid_a_sensors, 1, true);
SentientDeviceDef dev_rfid_b(naming::READER_B, naming::FRIENDLY_RFID_B, "rfid_reader", naming::ACTION_TYPE_CODE_READER, rfid_b_sensors, 1, true);
SentientDeviceDef dev_rfid_c(naming::READER_C, naming::FRIENDLY_RFID_C, "rfid_reader", naming::ACTION_TYPE_CODE_READER, rfid_c_sensors, 1, true);
SentientDeviceDef dev_rfid_d(naming::READER_D, naming::FRIENDLY_RFID_D, "rfid_reader", naming::ACTION_TYPE_CODE_READER, rfid_d_sensors, 1, true);
SentientDeviceDef dev_rfid_e(naming::READER_E, naming::FRIENDLY_RFID_E, "rfid_reader", naming::ACTION_TYPE_CODE_READER, rfid_e_sensors, 1, true);
...
SentientDeviceDef dev_fuse_a(naming::FUSE_A, naming::FRIENDLY_FUSE_A, "resistor_sensor", naming::ACTION_TYPE_ANALOG_SENSOR, fuse_a_sensors, 1, true);
SentientDeviceDef dev_fuse_b(naming::FUSE_B, naming::FRIENDLY_FUSE_B, "resistor_sensor", naming::ACTION_TYPE_ANALOG_SENSOR, fuse_b_sensors, 1, true);
SentientDeviceDef dev_fuse_c(naming::FUSE_C, naming::FRIENDLY_FUSE_C, "resistor_sensor", naming::ACTION_TYPE_ANALOG_SENSOR, fuse_c_sensors, 1, true);

// Knife switch sensor (input only)
const char *knife_switch_sensors[] = {naming::SENSOR_SWITCH_STATE};
SentientDeviceDef dev_knife_switch(naming::KNIFE_SWITCH, naming::FRIENDLY_KNIFE_SWITCH, "switch", naming::ACTION_TYPE_DIGITAL_SWITCH, knife_switch_sensors, 1, true);
...
SentientDeviceDef dev_actuator(naming::ACTUATOR, naming::FRIENDLY_ACTUATOR, "actuator", naming::ACTION_TYPE_MOTOR, actuator_commands, 3);

// Maglocks (output devices)
const char *maglock_commands[] = {naming::CMD_DROP_PANEL};
SentientDeviceDef dev_maglock_b(naming::MAGLOCK_B, naming::FRIENDLY_MAGLOCK_B, "maglock", naming::ACTION_TYPE_RELAY, maglock_commands, 1);
SentientDeviceDef dev_maglock_c(naming::MAGLOCK_C, naming::FRIENDLY_MAGLOCK_C, "maglock", naming::ACTION_TYPE_RELAY, maglock_commands, 1);
SentientDeviceDef dev_maglock_d(naming::MAGLOCK_D, naming::FRIENDLY_MAGLOCK_D, "maglock", naming::ACTION_TYPE_RELAY, maglock_commands, 1);

// Metal gate (output device)
const char *metal_gate_commands[] = {naming::CMD_UNLOCK_GATE};
SentientDeviceDef dev_metal_gate(naming::METAL_GATE, naming::FRIENDLY_METAL_GATE, "maglock", naming::ACTION_TYPE_RELAY, metal_gate_commands, 1);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    // Actuator commands
    if (strcmp(device_id, naming::ACTUATOR) == 0)
    {
    ...
    else if (strcmp(device_id, naming::MAGLOCK_B) == 0 && strcmp(command, naming::CMD_DROP_PANEL) == 0)
    {
        digitalWrite(PIN_MAGLOCK_B, LOW);
        Serial.println(F("[MAGLOCK_B] Panel dropped (unlocked)"));
    }
    // Maglock C drop command
    else if (strcmp(device_id, naming::MAGLOCK_C) == 0 && strcmp(command, naming::CMD_DROP_PANEL) == 0)
    {
        digitalWrite(PIN_MAGLOCK_C, LOW);
        Serial.println(F("[MAGLOCK_C] Panel dropped (unlocked)"));
    }
    // Maglock D drop command
    else if (strcmp(device_id, naming::MAGLOCK_D) == 0 && strcmp(command, naming::CMD_DROP_PANEL) == 0)
    {
        digitalWrite(PIN_MAGLOCK_D, LOW);
        Serial.println(F("[MAGLOCK_D] Panel dropped (unlocked)"));
    }
    // Metal gate unlock command
    else if (strcmp(device_id, naming::METAL_GATE) == 0 && strcmp(command, naming::CMD_UNLOCK_GATE) == 0)
    {
...
void monitor_rfid_readers()
{
    handle_rfid_reader(RFID_A, tag_a, last_tag_a, PIN_TIR_A, naming::READER_A);
    handle_rfid_reader(RFID_B, tag_b, last_tag_b, PIN_TIR_B, naming::READER_B);
    handle_rfid_reader(RFID_C, tag_c, last_tag_c, PIN_TIR_C, naming::READER_C);
    handle_rfid_reader(RFID_D, tag_d, last_tag_d, PIN_TIR_D, naming::READER_D);
    handle_rfid_reader(RFID_E, tag_e, last_tag_e, PIN_TIR_E, naming::READER_E);
}
