...
SentientDeviceDef dev_door_one(naming::DOOR_ONE, "Door One", "stepper_door", naming::ACTION_TYPE_MOTOR, door_commands, 3, door_sensors, 4);
SentientDeviceDef dev_door_two(naming::DOOR_TWO, "Door Two", "stepper_door", naming::ACTION_TYPE_MOTOR, door_commands, 3, door_sensors, 4);
SentientDeviceDef dev_canister_charging(naming::CANISTER_CHARGING, "Canister Charging", "digital_output", naming::ACTION_TYPE_RELAY, charging_commands, 2);
...
void monitor_sensors()
{
    ...
    if (d1_open_a != d1_open_a_last)
    {
        ...
        sentient.publishJson(naming::CAT_SENSORS, naming::DOOR_ONE, doc);
    ...
    if (d2_open_a != d2_open_a_last)
    {
        ...
        sentient.publishJson(naming::CAT_SENSORS, naming::DOOR_TWO, doc);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    // Door One
    if (strcmp(device_id, naming::DOOR_ONE) == 0)
    {
    ...
    // Door Two
    if (strcmp(device_id, naming::DOOR_TWO) == 0)
    {
        if (strcmp(command, naming::CMD_DOOR_OPEN) == 0)
        {
    ...
    // Canister Charging
    if (strcmp(device_id, naming::CANISTER_CHARGING) == 0)
    {
