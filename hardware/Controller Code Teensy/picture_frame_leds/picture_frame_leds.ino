...
SentientDeviceDef dev_tv_vincent(naming::TV_VINCENT, "Vincent TV LEDs", "led_strip", naming::ACTION_TYPE_RGB, tv_commands, 5);
SentientDeviceDef dev_tv_edith(naming::TV_EDITH, "Edith TV LEDs", "led_strip", naming::ACTION_TYPE_RGB, tv_commands, 5);
SentientDeviceDef dev_tv_maks(naming::TV_MAKS, "Maks TV LEDs", "led_strip", naming::ACTION_TYPE_RGB, tv_commands, 5);
SentientDeviceDef dev_tv_oliver(naming::TV_OLIVER, "Oliver TV LEDs", "led_strip", naming::ACTION_TYPE_RGB, tv_commands, 5);
SentientDeviceDef dev_all_tvs(naming::ALL_TVS, "All TVs", "led_strip", naming::ACTION_TYPE_RGB, tv_commands, 5);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    if (strcmp(device_id, naming::TV_VINCENT) == 0)
    {
        tv_start = tv_end = 0;
    }
    else if (strcmp(device_id, naming::TV_EDITH) == 0)
    {
        tv_start = tv_end = 1;
    }
    else if (strcmp(device_id, naming::TV_MAKS) == 0)
    {
        tv_start = tv_end = 2;
    }
    else if (strcmp(device_id, naming::TV_OLIVER) == 0)
    {
        tv_start = tv_end = 3;
    }
    else if (strcmp(device_id, naming::ALL_TVS) == 0)
    {
        tv_start = 0;
        tv_end = 3;
    }
