...
SentientDeviceDef dev_study_lights(
    naming::STUDY_LIGHTS, naming::FRIENDLY_STUDY_LIGHTS, "dimmer", naming::ACTION_TYPE_PWM, study_lights_commands, 1);

SentientDeviceDef dev_boiler_lights(
    naming::BOILER_LIGHTS, naming::FRIENDLY_BOILER_LIGHTS, "dimmer", naming::ACTION_TYPE_PWM, boiler_lights_commands, 1);

SentientDeviceDef dev_lab_lights_squares(
    naming::LAB_LIGHTS_SQUARES, naming::FRIENDLY_LAB_LIGHTS_SQUARES, "led_strip", naming::ACTION_TYPE_RGB, lab_lights_squares_commands, 2);

SentientDeviceDef dev_lab_lights_grates(
    naming::LAB_LIGHTS_GRATES, naming::FRIENDLY_LAB_LIGHTS_GRATES, "led_strip", naming::ACTION_TYPE_RGB, lab_lights_grates_commands, 2);

SentientDeviceDef dev_sconces(
    naming::SCONCES, naming::FRIENDLY_SCONCES, "relay", naming::ACTION_TYPE_RELAY, sconces_commands, 2);

SentientDeviceDef dev_crawlspace_lights(
    naming::CRAWLSPACE_LIGHTS, naming::FRIENDLY_CRAWLSPACE_LIGHTS, "relay", naming::ACTION_TYPE_RELAY, crawlspace_lights_commands, 2);
...
void setup()
{
  ...
  // Subscribe to device-scoped commands and set our own message handler
  {
    ...
    mqtt.get_client().setCallback([](char *topic, uint8_t *payload, unsigned int length)
      ...
      // Boiler Room Lights
      else if (device == naming::BOILER_LIGHTS) {
      ...
      else if (device == naming::LAB_LIGHTS_SQUARES) {
      ...
      else if (device == naming::LAB_LIGHTS_GRATES) {
      ...
      // Crawlspace Lights
      else if (device == naming::CRAWLSPACE_LIGHTS) {
