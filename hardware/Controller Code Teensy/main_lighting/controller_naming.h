...
namespace naming
{
    ...
    // Devices
    constexpr const char *STUDY_LIGHTS = "study_lights";
    constexpr const char *BOILER_LIGHTS = "boiler_lights";
    constexpr const char *LAB_LIGHTS_SQUARES = "lab_lights_squares";
    constexpr const char *LAB_LIGHTS_GRATES = "lab_lights_grates";
    constexpr const char *SCONCES = "sconces";
    constexpr const char *CRAWLSPACE_LIGHTS = "crawlspace_lights";
    ...
    // Study/Boiler dimmers (analog PWM output)
    constexpr const char *ACTION_TYPE_PWM = "analog_pwm";
    // Lab LED strips (RGB LED output)
    constexpr const char *ACTION_TYPE_RGB = "rgb_led";
    // Sconces/Crawlspace lights (digital relay output)
