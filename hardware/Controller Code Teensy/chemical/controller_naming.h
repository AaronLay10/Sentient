...
namespace naming
{
    ...
    constexpr const char *READER_F = "rfid_f";
    constexpr const char *ACTUATOR = "engine_block_actuator";
    constexpr const char *MAGLOCKS = "chest_maglocks";
