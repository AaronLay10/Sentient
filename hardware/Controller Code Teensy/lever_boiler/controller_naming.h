...
namespace naming
{
    ...
    constexpr const char *LEVER_BOILER = "lever_boiler";
    constexpr const char *LEVER_STAIRS = "lever_stairs";
    constexpr const char *NEWELL_POST = "newell_post";
    ...
    // Maglocks and LEDs (digital relay output)
    ...
    // Stepper motor (position control - output)
