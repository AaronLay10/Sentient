...
namespace naming
{
    ...
    // Devices
    constexpr const char *FLOOR_BUTTONS = "floor_buttons"; // 9 buttons
    constexpr const char *FLOOR_LEDS = "floor_leds";       // 9 LED strips
    constexpr const char *DRAWER_MAGLOCK = "drawer_maglock";
    constexpr const char *CUCKOO_SOLENOID = "cuckoo_solenoid";
    constexpr const char *DRAWER_LIGHTS = "drawer_cob_lights";
    constexpr const char *CRYSTAL_LIGHT = "crystal_light";
    constexpr const char *LEVER_MOTOR = "lever_motor";
    constexpr const char *LEVER_LED = "lever_rgb_led";
    constexpr const char *IR_SENSOR = "ir_sensor";
    constexpr const char *PHOTOCELL = "photocell";
    constexpr const char *DRAWER_PROXIMITY = "drawer_proximity";
    ...
    // Floor buttons and proximity sensors (digital switch input)
    ...
    // Maglock, solenoids, lights (digital relay output)
    constexpr const char *ACTION_TYPE_RELAY = "digital_relay";
    // Lever motor (motor control output)
