...
void drawerControl(const char *value)
{
  ...
  publish_command_acknowledgement(naming::LEVER_MOTOR, "drawer");
}
...
void solenoidControl(const char *value)
{
  ...
  // Publish acknowledgement
  publish_command_acknowledgement(naming::CUCKOO_SOLENOID, "solenoid");
}
...
void activateIR(const char *value)
{
  ...
  // Publish acknowledgement
  publish_command_acknowledgement(naming::IR_SENSOR, "activateIR");
}
...
void stateChange(const char *value)
{
  ...
  // Publish acknowledgement
  publish_command_acknowledgement(naming::FLOOR_LEDS, "state");
}
...
void leverControl(const char *value)
{
  ...
  // Publish acknowledgement
  publish_command_acknowledgement(naming::LEVER_LED, "lever");
}
