...
SentientDeviceDef dev_door(
    naming::DOOR, naming::FRIENDLY_DOOR, "actuator", naming::ACTION_TYPE_MOTOR, door_commands, 3);

SentientDeviceDef dev_maglock(
    naming::MAGLOCK, naming::FRIENDLY_MAGLOCK, "relay", naming::ACTION_TYPE_RELAY, maglock_commands, 2);

SentientDeviceDef dev_leds(
    naming::LED_STRIP, naming::FRIENDLY_LED_STRIP, "led_strip", naming::ACTION_TYPE_RGB, led_commands, 3);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    if (strcmp(device_id, naming::DOOR) == 0)
    {
        // Door lift commands
    ...
    else if (strcmp(device_id, naming::MAGLOCK) == 0)
    {
        // Maglock commands
    ...
    else if (strcmp(device_id, naming::LED_STRIP) == 0)
    {
        // LED strip commands
