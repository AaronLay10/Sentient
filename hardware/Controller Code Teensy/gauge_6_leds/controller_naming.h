...
namespace naming
{
    ...
    constexpr const char *GAUGE_6 = "gauge_6";
    constexpr const char *LEVER_1_RED = "lever_1_red";
    constexpr const char *LEVER_2_BLUE = "lever_2_blue";
    constexpr const char *LEVER_3_GREEN = "lever_3_green";
    constexpr const char *LEVER_4_WHITE = "lever_4_white";
    constexpr const char *LEVER_5_ORANGE = "lever_5_orange";
    constexpr const char *LEVER_6_YELLOW = "lever_6_yellow";
    constexpr const char *LEVER_7_PURPLE = "lever_7_purple";
    constexpr const char *CEILING_LEDS = "ceiling_leds";
    constexpr const char *GAUGE_LEDS = "gauge_leds";
