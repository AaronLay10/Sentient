...
void publish_sensor_changes(bool force_publish)
{
    ...
    if (green_bottom_state != last_green_bottom || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::GREEN_KEY_BOX) + "/" + SENSOR_GREEN_BOTTOM).c_str(), doc);
    ...
    if (green_right_state != last_green_right || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::GREEN_KEY_BOX) + "/" + SENSOR_GREEN_RIGHT).c_str(), doc);
    ...
    if (yellow_right_state != last_yellow_right || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::YELLOW_KEY_BOX) + "/" + SENSOR_YELLOW_RIGHT).c_str(), doc);
    ...
    if (yellow_top_state != last_yellow_top || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::YELLOW_KEY_BOX) + "/" + SENSOR_YELLOW_TOP).c_str(), doc);
    ...
    if (blue_left_state != last_blue_left || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::BLUE_KEY_BOX) + "/" + SENSOR_BLUE_LEFT).c_str(), doc);
    ...
    if (blue_bottom_state != last_blue_bottom || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::BLUE_KEY_BOX) + "/" + SENSOR_BLUE_BOTTOM).c_str(), doc);
    ...
    if (red_left_state != last_red_left || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::RED_KEY_BOX) + "/" + SENSOR_RED_LEFT).c_str(), doc);
    ...
    if (red_bottom_state != last_red_bottom || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::RED_KEY_BOX) + "/" + SENSOR_RED_BOTTOM).c_str(), doc);
    ...
    if (green_pair_state != last_green_pair || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::GREEN_KEY_BOX) + "/" + SENSOR_GREEN_PAIR).c_str(), doc);
    ...
    if (yellow_pair_state != last_yellow_pair || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::YELLOW_KEY_BOX) + "/" + SENSOR_YELLOW_PAIR).c_str(), doc);
    ...
    if (blue_pair_state != last_blue_pair || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::BLUE_KEY_BOX) + "/" + SENSOR_BLUE_PAIR).c_str(), doc);
    ...
    if (red_pair_state != last_red_pair || !sensors_initialized || force_publish)
    {
        ...
        mqtt.publishJson(CAT_SENSORS, (String(naming::RED_KEY_BOX) + "/" + SENSOR_RED_PAIR).c_str(), doc);
