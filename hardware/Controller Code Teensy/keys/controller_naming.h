...
namespace naming
{
    ...
    constexpr const char *BLUE_KEY_BOX = "blue_key_box";
    constexpr const char *GREEN_KEY_BOX = "green_key_box";
    constexpr const char *YELLOW_KEY_BOX = "yellow_key_box";
    constexpr const char *RED_KEY_BOX = "red_key_box";
    ...
    // Button switches (digital switch input)
