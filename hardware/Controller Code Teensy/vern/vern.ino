...
SentientDeviceDef dev_output_one(naming::OUTPUT_ONE, "Output 1", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_two(naming::OUTPUT_TWO, "Output 2", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_three(naming::OUTPUT_THREE, "Output 3", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_four(naming::OUTPUT_FOUR, "Output 4", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_five(naming::OUTPUT_FIVE, "Output 5", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_six(naming::OUTPUT_SIX, "Output 6", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_seven(naming::OUTPUT_SEVEN, "Output 7", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_output_eight(naming::OUTPUT_EIGHT, "Output 8", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
SentientDeviceDef dev_power_switch(naming::POWER_SWITCH, "Power Switch", "digital_output", naming::ACTION_TYPE_RELAY, output_commands, 2);
...
void handle_mqtt_command(const char *command, const JsonDocument &payload, void *ctx)
{
    ...
    if (strcmp(device_id, naming::OUTPUT_ONE) == 0)
        pin = PIN_OUTPUT_ONE;
    else if (strcmp(device_id, naming::OUTPUT_TWO) == 0)
        pin = PIN_OUTPUT_TWO;
    else if (strcmp(device_id, naming::OUTPUT_THREE) == 0)
        pin = PIN_OUTPUT_THREE;
    else if (strcmp(device_id, naming::OUTPUT_FOUR) == 0)
        pin = PIN_OUTPUT_FOUR;
    else if (strcmp(device_id, naming::OUTPUT_FIVE) == 0)
        pin = PIN_OUTPUT_FIVE;
    else if (strcmp(device_id, naming::OUTPUT_SIX) == 0)
        pin = PIN_OUTPUT_SIX;
    else if (strcmp(device_id, naming::OUTPUT_SEVEN) == 0)
        pin = PIN_OUTPUT_SEVEN;
    else if (strcmp(device_id, naming::OUTPUT_EIGHT) == 0)
        pin = PIN_OUTPUT_EIGHT;
    else if (strcmp(device_id, naming::POWER_SWITCH) == 0)
