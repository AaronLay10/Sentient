...
void publish_sensor_changes(bool force_publish)
{
  ...
  if (force_publish || button1_state != last_published_button1)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_1) + "/" + SENSOR_BUTTON_1_PRESSED).c_str(), doc);
  ...
  if (force_publish || button2_state != last_published_button2)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_2) + "/" + SENSOR_BUTTON_2_PRESSED).c_str(), doc);
  ...
  if (force_publish || button3_state != last_published_button3)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_3) + "/" + SENSOR_BUTTON_3_PRESSED).c_str(), doc);
  ...
  if (force_publish || button4_state != last_published_button4)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_4) + "/" + SENSOR_BUTTON_4_PRESSED).c_str(), doc);
  ...
  if (force_publish || button5_state != last_published_button5)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_5) + "/" + SENSOR_BUTTON_5_PRESSED).c_str(), doc);
  ...
  if (force_publish || button6_state != last_published_button6)
  {
    ...
    mqtt.publishJson(CAT_SENSORS, (String(naming::BUTTON_6) + "/" + SENSOR_BUTTON_6_PRESSED).c_str(), doc);
